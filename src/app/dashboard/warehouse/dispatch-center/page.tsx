...
import { getContainers, lockEntity, releaseLock, getAssignmentsForContainer, moveAssignmentToContainer, updateAssignmentStatus, resetContainerAssignments, unassignDocumentFromContainer, unassignAllFromContainer } from '@/modules/warehouse/lib/actions';
                                    ...
                                    {hasPermission('warehouse:dispatch-containers:manage') && (
                                        <AlertDialog>
                                            <AlertDialogTrigger asChild>
                                                <Button variant="ghost" size="icon" className="h-7 w-7 text-muted-foreground hover:text-destructive" onClick={() => setContainerToModify(c)}>
                                            ...
                                            <AlertDialogContent>
                                                <AlertDialogHeader>
                                                    ...
                                                    <AlertDialogDescription>
                                                        Esta acción desasignará TODOS los documentos del contenedor "{c.name}". Los despachos ya completados no se verán afectados.
                                                    </AlertDialogDescription>
                                                </AlertDialogHeader>
                                                <AlertDialogFooter>
                                                    <AlertDialogCancel>Cancelar</AlertDialogCancel>
                                                    <AlertDialogAction onClick={handleClearContainer}>Sí, Limpiar</AlertDialogAction>
                                                </AlertDialogFooter>
                                            </AlertDialogContent>
                                        </AlertDialog>
                                    )}
...
```
  ...
  <change>
    <file>/src/modules/core/types/index.ts</file>
    <content><![CDATA[/**
